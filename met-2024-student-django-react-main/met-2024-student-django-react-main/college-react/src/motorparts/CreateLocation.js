            ...
            {!status ?
                ...
                <div className='w-full max-w-lg'>
                    ...
                    <div class="mx-3 mb-6 content-center p-3">
                        ...
                        <Link to={() => window.location.reload()} class="m-1 bg-transparent hover:bg-green-700 text-green-700 font-semibold hover:text-white py-2 px-4 border border-green-700 hover:border-transparent rounded">
                            Add More
                        </Link>
                    </div>
                </div>
